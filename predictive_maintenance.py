...
# Remove the 'widgets' key from the notebook metadata if it exists
if 'widgets' in notebook.get('metadata', {}):
    del notebook['metadata']['widgets']
    print("'widgets' metadata removed.")

# Optionally, remove 'widgets' from cell metadata as well (if present)
...
print(f"Notebook saved after cleaning metadata: {notebook_path}")
